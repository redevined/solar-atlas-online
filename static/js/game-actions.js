...
var Actions, AttackActions, BaseActions, BuildActions, MoveActions, TradeActions, sysradius,
...
Actions = (function(superClass) {
  ...
  function Actions(game) {
    ...
    Actions.__super__.constructor.call(this, game);
    this.actions = {
  ...
  Actions.prototype.setActionsSelectable = function(system) {
  ...
  Actions.prototype.getAction = function(piece) {
    switch (piece.color) {
      case "red":
