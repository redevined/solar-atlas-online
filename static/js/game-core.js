...
Element = (function() {
  ...
  Element.prototype.click = function(key, handler) {
    return this.e.on("click." + key, handler);
  };

  Element.prototype.unclick = function(key) {
    return this.e.off("click." + key);
  };
...
Stash = (function(superClass) {
  ...
  Stash.prototype.clickRow = function(color, key, handler) {
    return this.e.find("tr.stash-" + color).on("click." + key, handler);
  };

  Stash.prototype.clickCell = function(color, size, key, handler) {
    return this.e.find("tr.stash-" + color + " > td.stash-" + size).on("click." + key, handler);
  };

  Stash.prototype.unclickRows = function(key) {
    return this.e.find("tr").off("click." + key);
  };

  Stash.prototype.unclickCells = function(key) {
    return this.e.find("td").off("click." + key);
  };
...
System = (function(superClass) {
  ...
  System.prototype.click = function(key, handler) {
    return this.e.find(".system").on("click." + key, handler);
  };

  System.prototype.unclick = function(key) {
    return this.e.find(".system").off("click." + key);
  };
